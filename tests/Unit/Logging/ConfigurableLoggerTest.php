...
namespace Kommandhub\DemoData\Tests\Unit\Logging;

use Kommandhub\DemoData\Logging\ConfigurableLogger;
use Kommandhub\DemoData\Setting\Service\Config;
...
class ConfigurableLoggerTest extends TestCase
{
     ...
     * resolve it against the channel the entry belongs to. DemoData's logger
